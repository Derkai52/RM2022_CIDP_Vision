...
//#include <serials.h>
#include <CoordinateSolver/BuffCoordinateSolver.h>
#include <additions.h>
//#include <additions.h>
#include "RMDefine.h"
#include "Conf.h"
...
public:
    ...
    void calculateFinalResult(const cv::Point2f armor_box_points[4], ArmorType armorType, DistinguishMode distinguishMode, CarType carType, float pitchAngle, float yawAngle, float shootSpeed, bool sameTargetFlag, int targetWidth, bool topFlag = false);
     ...
     */// TODO: 目标发送这个地方需要结合实际书写
    void getAngleCalculateData(TX2CmdStruct *TX2Cmd);
    ...
    BuffCoordinateSolver::CoordinateStruct get_result(){
        return _buffCoordinateStruct;
    }

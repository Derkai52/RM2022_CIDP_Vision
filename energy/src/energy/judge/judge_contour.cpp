...
//        cout<<cur_contour_area<<" "<<energy_part_param_.FAN_CONTOUR_AREA_MIN<<" "<<energy_part_param_.FAN_CONTOUR_AREA_MAX<<endl;
...
//        cout<<"length width fail."<< "length: " << length << ' ' << "width: " << width <<endl;
//        cout << "length: " << length << '\t' << "width: " << width << '\t' << cur_rect.center << endl;
        return false;
        //矩形边长不合适
    }
...
//    cout << cur_contour_area << endl; // TODO: 调试装甲板面积
...
//        cout<<cur_contour_area<<" "<<energy_part_param_.CENTER_R_CONTOUR_AREA_MIN<<" "<<energy_part_param_.CENTER_R_CONTOUR_AREA_MAX<<endl<<endl;
//        cout<<"area fail."<<cur_contour_area<<endl;
        return false;
        //选区面积大小不合适
    }
...
//    cout << cur_contour_area << endl; // TODO: 调试流动条扇叶面积
...
//        cout<<"area fail."<< "area: " << cur_contour_area << '\t' <<endl;

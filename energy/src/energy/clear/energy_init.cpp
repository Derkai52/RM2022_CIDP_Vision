...
void Energy::initEnergyPartParam() {
    energy_part_param_.RED_GRAY_THRESH = 190;//game 160  //红方二值化阈值
    energy_part_param_.BLUE_GRAY_THRESH = 120;//game 80  //蓝方二值化阈值
    energy_part_param_.SPLIT_GRAY_THRESH = 200; // 190   //通道分离二值化阈值

    energy_part_param_.FAN_CONTOUR_AREA_MAX = 3000; //扇叶面积最大值 5000
    energy_part_param_.FAN_CONTOUR_AREA_MIN = 1500;
    energy_part_param_.FAN_CONTOUR_LENGTH_MIN = 25;  //扇叶长边长度最小值
    energy_part_param_.FAN_CONTOUR_LENGTH_MAX = 100;
    energy_part_param_.FAN_CONTOUR_WIDTH_MIN = 0;  //扇叶宽边长度最小值
    energy_part_param_.FAN_CONTOUR_WIDTH_MAX = 50;
    ...
    energy_part_param_.ARMOR_CONTOUR_AREA_MAX = 1500; //装甲板面积最大值 500
    ...
    energy_part_param_.CENTER_R_CONTOUR_AREA_MAX = 400; //风车中心R面积最大值
    energy_part_param_.CENTER_R_CONTOUR_AREA_MIN = 30; //g 40
    energy_part_param_.CENTER_R_CONTOUR_LENGTH_MIN = 10; //风车中心R长边长度最小值 //6
    energy_part_param_.CENTER_R_CONTOUR_LENGTH_MAX = 30; // 20
    energy_part_param_.CENTER_R_CONTOUR_WIDTH_MIN = 3; //风车中心R长边长度最小值 // 6
    energy_part_param_.CENTER_R_CONTOUR_WIDTH_MAX = 20; // 20
    ...
    energy_part_param_.FLOW_STRIP_FAN_CONTOUR_AREA_MAX = 3300; //流动条扇叶（待击打）面积最大值 2000
    energy_part_param_.FLOW_STRIP_FAN_CONTOUR_AREA_MIN = 250; // 500
    energy_part_param_.FLOW_STRIP_FAN_CONTOUR_LENGTH_MIN = 10; //流动条扇叶（待击打）长边长度最小值 60
    energy_part_param_.FLOW_STRIP_FAN_CONTOUR_LENGTH_MAX = 140; // 100
    energy_part_param_.FLOW_STRIP_FAN_CONTOUR_WIDTH_MIN = 5; //流动条扇叶（待击打）宽边长度最小值 //20
    ...
    energy_part_param_.FLOW_STRIP_CONTOUR_AREA_MIN = 50;
